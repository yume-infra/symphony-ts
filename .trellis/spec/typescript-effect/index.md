...
- [ ] Run or trust the latest passing `pnpm effect:source:verify` before relying on the vendored
      subtree source.
...
- executable subtree-source verification through `pnpm effect:source:verify`
